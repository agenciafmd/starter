...
'auth.guards.admix-web.driver','auth.guards.admix-web.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers.admix-users.driver',
'auth.providers.admix-users.model','auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle',
'auth.passwords.admix-users.provider','auth.passwords.admix-users.table','auth.passwords.admix-users.expire','auth.passwords.admix-users.throttle','auth.password_timeout',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.cdn.driver','filesystems.disks.cdn.host','filesystems.disks.cdn.username',
'filesystems.disks.cdn.password','filesystems.disks.cdn.url','filesystems.disks.cdn.ssl','filesystems.links./var/www/html/public/storage','google-fonts.fonts.default',
'google-fonts.disk','google-fonts.path','google-fonts.inline','google-fonts.preload','google-fonts.fallback',
'google-fonts.user_agent','horizon.domain','horizon.path','horizon.use','horizon.prefix',
...
'horizon.environments.production.supervisor-1.balanceMaxShift','horizon.environments.production.supervisor-1.balanceCooldown','horizon.environments.local.supervisor-1.maxProcesses','livewire.class_namespace','livewire.view_path',
...
'session.partitioned','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.argon.memory',
...
'audit-alias.Agenciafmd\\Admix\\Models\\Role','admix-icons.sets.0.name','admix-icons.sets.0.prefix','admix-icons.sets.0.path','admix-icons.sets.1.name',
'admix-icons.sets.1.prefix','admix-icons.sets.1.path','admix-leads.name','admix-leads.icon','admix-leads.sort',
'admix-leads.sources','admix-postal.name','admix-postal.icon','admix-postal.sort','admix-ui.prefix',
'admix-ui.tabler.path','admix-ui.tabler.version','frontend.google.tagmanager','frontend.google.site_verification','laravel-page-speed.php.enable',
'laravel-page-speed.php.skip','social-meta.default.card.width','social-meta.default.card.height','social-meta.default.card.fill','social-meta.default.card.color',
'social-meta.default.logo.path','social-meta.default.logo.position','social-meta.default.logo.x','social-meta.default.logo.y','social-meta.default.title.font.file',
'social-meta.default.title.font.size','social-meta.default.title.font.color','social-meta.default.title.font.align','social-meta.default.title.font.valign','social-meta.default.title.x',
'social-meta.default.title.y','social-meta.default.title.maxlength','social-meta.default.title.line_height','social-meta.default.url.font.file','social-meta.default.url.font.size',
'social-meta.default.url.font.color','social-meta.default.url.font.align','social-meta.default.url.font.valign','social-meta.default.url.x','social-meta.default.url.y',
'social-meta.facebook','laravel-turbo.enable','laravel-turbo.middlewares','blade-heroicons.prefix','blade-heroicons.fallback',
'blade-heroicons.class','blade-heroicons.attributes','blade-icons.sets','blade-icons.class','blade-icons.attributes',
'blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','gate.0.name','gate.0.policy',
...
'errors.minimal','errors::minimal','frontend::components.fonts-preload','frontend::components.gtm-body','frontend::components.gtm-head',
'frontend::components.link','frontend::components.pdf','frontend::components.picture','frontend::components.pwa','frontend::components.single-source',
'frontend::components.site-verification','frontend::components.sources','frontend::html.index','frontend::html.internal','frontend::html.master',
'frontend::html.partials.footer','frontend::html.partials.header','frontend::html.partials.internal-header','frontend::html.partials.message','frontend::html.partials.picture',
'frontend::html.tema-old','frontend::internal','frontend::master','frontend::pages.index','frontend::partials.footer',
'frontend::partials.header','frontend::partials.internal-header','frontend::partials.message','frontend::partials.pagination','frontend::partials.picture',
'livewire-tables::components.pagination','livewire-tables::components.table.td.plain','livewire-tables::components.table.th.plain','livewire-tables::components.table.tr','livewire-tables::components.table.tr.bulk-actions',
'livewire-tables::components.tools.filter-label','livewire-tables::components.tools.filters.text-field','livewire-tables::components.tools.toolbar.items.bulk-actions','livewire-tables::components.tools.toolbar.items.column-select','livewire-tables::components.tools.toolbar.items.filter-button',
'livewire-tables::components.tools.toolbar.items.filter-popover','livewire-tables::components.tools.toolbar.items.search-field','livewire-tables::includes.custom','vendor.livewire-tables.components.pagination','vendor.livewire-tables.components.table.td.plain',
'vendor.livewire-tables.components.table.th.plain','vendor.livewire-tables.components.table.tr','vendor.livewire-tables.components.table.tr.bulk-actions','vendor.livewire-tables.components.tools.filter-label','vendor.livewire-tables.components.tools.filters.text-field',
'vendor.livewire-tables.components.tools.toolbar.items.bulk-actions','vendor.livewire-tables.components.tools.toolbar.items.column-select','vendor.livewire-tables.components.tools.toolbar.items.filter-button','vendor.livewire-tables.components.tools.toolbar.items.filter-popover','vendor.livewire-tables.components.tools.toolbar.items.search-field',
...
'pt_BR.0','crud.success.store','crud.success.update','crud.success.save','crud.success.delete',
'crud.success.restore','crud.error.store','crud.error.update','crud.error.save','crud.error.delete',
'crud.error.restore','events.created','events.updated','events.deleted','events.restored',
'fields.auditable_id','fields.auditable_type','fields.avatar','fields.avatar_files','fields.bcc',
'fields.can_notify','fields.cc','fields.check_email','fields.confirm_password','fields.created_at',
'fields.email','fields.end_date','fields.event','fields.file','fields.files',
'fields.forgot_password','fields.hide_at','fields.id','fields.image','fields.images',
'fields.initial_date','fields.is_active','fields.library','fields.library_files','fields.gallery',
'fields.gallery_files','fields.login','fields.logout','fields.media.avatar','fields.media.image',
'fields.media.images','fields.name','fields.new_password','fields.not_receive_email','fields.password',
'fields.password_confirmation','fields.publish_at','fields.register','fields.remember','fields.request_another',
'fields.reset_password','fields.role_id','fields.rules','fields.send_password_reset_link','fields.slug',
'fields.subject','fields.to','fields.to_name','fields.updated_at','fields.user',
'fields.verify_email','fields.verify_email_link','passwords.password','validation.attributes.address','validation.attributes.age',
'validation.attributes.birth_date','validation.attributes.blood_type','validation.attributes.body','validation.attributes.category','validation.attributes.cell',
'validation.attributes.city','validation.attributes.company_name','validation.attributes.complement','validation.attributes.country','validation.attributes.current_password',
'validation.attributes.date','validation.attributes.day','validation.attributes.description','validation.attributes.excerpt','validation.attributes.first_name',
'validation.attributes.gender','validation.attributes.hour','validation.attributes.last_name','validation.attributes.marital_status','validation.attributes.message',
'validation.attributes.minute','validation.attributes.mobile','validation.attributes.modality','validation.attributes.month','validation.attributes.name',
'validation.attributes.nationality','validation.attributes.neighborhood','validation.attributes.number','validation.attributes.password','validation.attributes.password_confirmation',
'validation.attributes.phone','validation.attributes.profession','validation.attributes.second','validation.attributes.sex','validation.attributes.short_description',
...
'validation.attributes.title','validation.attributes.username','validation.attributes.year','validation.attributes.zipcode','admix::pt_BR.0',
'admix::auth.0','admix::crud.0','admix::events.0','admix::fields.0','admix::pagination.0',
'admix::passwords.0','admix::validation.0','admix-leads::pt_BR.0','admix-leads::fields.0','admix-postal::pt_BR.0',
'admix-postal::fields.0','admix-ui::pt_BR.0','admix-ui::fields.0','livewire-tables::core.All','livewire-tables::core.All Columns',
'livewire-tables::core.Applied Filters','livewire-tables::core.Applied Sorting','livewire-tables::core.Bulk Actions','livewire-tables::core.Bulk Actions Confirm','livewire-tables::core.cancel',
'livewire-tables::core.Clear','livewire-tables::core.Columns','livewire-tables::core.Debugging Values','livewire-tables::core.Deselect All','livewire-tables::core.Done Reordering',
'livewire-tables::core.Filters','livewire-tables::core.loading','livewire-tables::core.max','livewire-tables::core.min','livewire-tables::core.not_applicable',
'livewire-tables::core.No','livewire-tables::core.No items found, try to broaden your search','livewire-tables::core.of','livewire-tables::core.Remove filter option','livewire-tables::core.Remove sort option',
'livewire-tables::core.Reorder','livewire-tables::core.results','livewire-tables::core.row','livewire-tables::core.rows','livewire-tables::core.rows, do you want to select all',
'livewire-tables::core.save','livewire-tables::core.Search','livewire-tables::core.Select All','livewire-tables::core.Select All On Page','livewire-tables::core.Showing',
'livewire-tables::core.to','livewire-tables::core.Yes','livewire-tables::core.You are currently selecting all','livewire-tables::core.You are not connected to the internet','livewire-tables::core.You have selected',);
