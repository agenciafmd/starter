...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'audit.allowed_empty_values' => 'string',
            ...
            'laravel-page-speed.php.skip' => 'string',
            ...
            'laravel-turbo.middlewares' => 'string',
...
'laravel-exceptions::503','laravel-exceptions::layout','laravel-exceptions::minimal','livewire-tables::components.includes.actions','livewire-tables::components.includes.loading',
'livewire-tables::components.pagination','livewire-tables::components.table','livewire-tables::components.table.collapsed-columns','livewire-tables::components.table.empty','livewire-tables::components.table.td',
'livewire-tables::components.table.td.bulk-actions','livewire-tables::components.table.td.collapsed-columns','livewire-tables::components.table.td.plain','livewire-tables::components.table.td.reorder','livewire-tables::components.table.th',
'livewire-tables::components.table.th.bulk-actions','livewire-tables::components.table.th.collapsed-columns','livewire-tables::components.table.th.label','livewire-tables::components.table.th.plain','livewire-tables::components.table.th.reorder',
'livewire-tables::components.table.th.sort-icons','livewire-tables::components.table.tr','livewire-tables::components.table.tr.bulk-actions','livewire-tables::components.table.tr.footer','livewire-tables::components.table.tr.plain',
'livewire-tables::components.table.tr.secondary-header','livewire-tables::components.tools','livewire-tables::components.tools.filter-label','livewire-tables::components.tools.filter-pills','livewire-tables::components.tools.filter-pills.buttons.reset-all',
'livewire-tables::components.tools.filter-pills.buttons.reset-filter','livewire-tables::components.tools.filter-pills.item','livewire-tables::components.tools.filters.boolean','livewire-tables::components.tools.filters.date','livewire-tables::components.tools.filters.date-range',
'livewire-tables::components.tools.filters.datetime','livewire-tables::components.tools.filters.livewire-component-array-filter','livewire-tables::components.tools.filters.livewire-component-filter','livewire-tables::components.tools.filters.multi-select','livewire-tables::components.tools.filters.multi-select-dropdown',
'livewire-tables::components.tools.filters.number','livewire-tables::components.tools.filters.number-range','livewire-tables::components.tools.filters.select','livewire-tables::components.tools.filters.text-field','livewire-tables::components.tools.sorting-pills',
'livewire-tables::components.tools.toolbar','livewire-tables::components.tools.toolbar.items.bulk-actions','livewire-tables::components.tools.toolbar.items.column-select','livewire-tables::components.tools.toolbar.items.filter-button','livewire-tables::components.tools.toolbar.items.filter-popover',
'livewire-tables::components.tools.toolbar.items.filter-popover.clear-button','livewire-tables::components.tools.toolbar.items.filter-slidedown','livewire-tables::components.tools.toolbar.items.pagination-dropdown','livewire-tables::components.tools.toolbar.items.reorder-buttons','livewire-tables::components.tools.toolbar.items.search-field',
'livewire-tables::components.tools.toolbar.items.search.icon','livewire-tables::components.tools.toolbar.items.search.input','livewire-tables::components.tools.toolbar.items.search.remove','livewire-tables::components.wrapper','livewire-tables::datatable',
'livewire-tables::includes.actions.button','livewire-tables::includes.columns.boolean','livewire-tables::includes.columns.button-group','livewire-tables::includes.columns.color','livewire-tables::includes.columns.date',
'livewire-tables::includes.columns.icon','livewire-tables::includes.columns.image','livewire-tables::includes.columns.increment','livewire-tables::includes.columns.link','livewire-tables::includes.columns.wire-link',
'livewire-tables::includes.debug','livewire-tables::includes.offline','livewire-tables::specific.bootstrap-4.pagination','livewire-tables::specific.bootstrap-4.simple-pagination','livewire-tables::specific.tailwind.pagination',
