...
'admix-ui.tabler.version','frontend.google.tagmanager','frontend.google.site_verification','laravel-page-speed.php.enable','laravel-page-speed.php.skip',
'social-meta.default.card.width','social-meta.default.card.height','social-meta.default.card.fill','social-meta.default.card.color','social-meta.default.logo.path',
'social-meta.default.logo.position','social-meta.default.logo.x','social-meta.default.logo.y','social-meta.default.title.font.file','social-meta.default.title.font.size',
'social-meta.default.title.font.color','social-meta.default.title.font.align','social-meta.default.title.font.valign','social-meta.default.title.x','social-meta.default.title.y',
'social-meta.default.title.maxlength','social-meta.default.title.line_height','social-meta.default.url.font.file','social-meta.default.url.font.size','social-meta.default.url.font.color',
'social-meta.default.url.font.align','social-meta.default.url.font.valign','social-meta.default.url.x','social-meta.default.url.y','social-meta.facebook',
'laravel-turbo.enable','laravel-turbo.middlewares','blade-heroicons.prefix','blade-heroicons.fallback','blade-heroicons.class',
'blade-heroicons.attributes','blade-icons.sets','blade-icons.class','blade-icons.attributes','blade-icons.fallback',
'blade-icons.components.disabled','blade-icons.components.default','sitemap.guzzle_options.cookies','sitemap.guzzle_options.connect_timeout','sitemap.guzzle_options.timeout',
'sitemap.guzzle_options.allow_redirects','sitemap.execute_javascript','sitemap.chrome_binary_path','sitemap.crawl_profile','gate.0.name',
'gate.0.policy','gate.0.abilities.0.name','gate.0.abilities.0.method','gate.0.abilities.1.name','gate.0.abilities.1.method',
'gate.0.abilities.2.name','gate.0.abilities.2.method','gate.0.abilities.3.name','gate.0.abilities.3.method','gate.0.abilities.4.name',
'gate.0.abilities.4.method','gate.0.sort','gate.1.name','gate.1.policy','gate.1.abilities.0.name',
'gate.1.abilities.0.method','gate.1.abilities.1.name','gate.1.abilities.1.method','gate.1.abilities.2.name','gate.1.abilities.2.method',
'gate.1.abilities.3.name','gate.1.abilities.3.method','gate.1.abilities.4.name','gate.1.abilities.4.method','gate.1.sort',
'gate.2.name','gate.2.policy','gate.2.abilities.0.name','gate.2.abilities.0.method','gate.2.abilities.1.name',
'gate.2.abilities.1.method','gate.2.abilities.2.name','gate.2.abilities.2.method','gate.2.abilities.3.name','gate.2.abilities.3.method',
'gate.2.abilities.4.name','gate.2.abilities.4.method','gate.2.sort','gate.3.name','gate.3.policy',
'gate.3.abilities.0.name','gate.3.abilities.0.method','gate.3.abilities.1.name','gate.3.abilities.1.method','gate.3.abilities.2.name',
'gate.3.abilities.2.method','gate.3.abilities.3.name','gate.3.abilities.3.method','gate.3.abilities.4.name','gate.3.abilities.4.method',
'gate.3.sort','gate.4.name','gate.4.policy','gate.4.abilities.0.name','gate.4.abilities.0.method',
'gate.4.sort','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
