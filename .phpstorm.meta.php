...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'admix-categories.categories.0.types.0.image' => 'array',
            'admix-categories.categories.0.types.1.name' => 'string',
            'admix-categories.categories.0.types.1.slug' => 'string',
            'admix-categories.categories.0.types.1.is_nested' => 'boolean',
            'admix-categories.categories.0.types.1.has_color' => 'boolean',
            'admix-categories.categories.0.types.1.has_description' => 'boolean',
            'admix-categories.categories.0.types.1.image.max_size' => 'string',
            'admix-categories.categories.0.types.1.image.max_width' => 'string',
            'admix-categories.categories.0.types.1.image.max_height' => 'string',
            'admix-categories.categories.0.types.1.image.ratio' => 'integer',
...
'admix-categories.categories.0.types.0.has_description','admix-categories.categories.0.types.0.image','admix-categories.categories.0.types.1.name','admix-categories.categories.0.types.1.slug','admix-categories.categories.0.types.1.is_nested',
'admix-categories.categories.0.types.1.has_color','admix-categories.categories.0.types.1.has_description','admix-categories.categories.0.types.1.image.max_size','admix-categories.categories.0.types.1.image.max_width','admix-categories.categories.0.types.1.image.max_height',
'admix-categories.categories.0.types.1.image.ratio','admix-categories.categories.1.model','admix-categories.categories.1.name','admix-categories.categories.1.slug','admix-categories.categories.1.types.0.name',
'admix-categories.categories.1.types.0.slug','admix-categories.categories.1.types.1.name','admix-categories.categories.1.types.1.slug','admix-categories.categories.1.types.2.name','admix-categories.categories.1.types.2.slug',
'admix-icons.sets.0.name','admix-icons.sets.0.prefix','admix-icons.sets.0.path','admix-icons.sets.1.name','admix-icons.sets.1.prefix',
'admix-icons.sets.1.path','admix-icons.sets.2.name','admix-icons.sets.2.prefix','admix-icons.sets.2.path','app.name',
...
'auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider','auth.guards.admix-web.driver',
'auth.guards.admix-web.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers.admix-users.driver','auth.providers.admix-users.model',
'auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.passwords.admix-users.provider',
'auth.passwords.admix-users.table','auth.passwords.admix-users.expire','auth.passwords.admix-users.throttle','auth.password_timeout','cache.default',
...
'filesystems.disks.s3.throw','filesystems.disks.fonts.driver','filesystems.disks.fonts.root','filesystems.disks.fonts.url','filesystems.disks.fonts.visibility',
'filesystems.disks.fonts.throw','filesystems.disks.cdn.driver','filesystems.disks.cdn.host','filesystems.disks.cdn.username','filesystems.disks.cdn.password',
'filesystems.disks.cdn.url','filesystems.disks.cdn.ssl','filesystems.links./var/www/html/public/storage','google-fonts.fonts.default','google-fonts.disk',
'google-fonts.path','google-fonts.inline','google-fonts.preload','google-fonts.fallback','google-fonts.user_agent',
...
'horizon.environments.production.supervisor-1.balanceCooldown','horizon.environments.develop.supervisor-1.maxProcesses','horizon.environments.local.supervisor-1.maxProcesses','livewire.class_namespace','livewire.view_path',
...
'livewire-tables.dateRange.defaultConfig.dateFormat','livewire-tables.dateRange.defaultConfig.earliestDate','livewire-tables.dateRange.defaultConfig.latestDate','livewire-tables.numberRange.defaultOptions.min','livewire-tables.numberRange.defaultOptions.max',
'livewire-tables.numberRange.defaultConfig.minRange','livewire-tables.numberRange.defaultConfig.maxRange','livewire-tables.numberRange.defaultConfig.suffix','livewire-tables.selectFilter.defaultOptions','livewire-tables.selectFilter.defaultConfig',
'livewire-tables.multiSelectFilter.defaultOptions','livewire-tables.multiSelectFilter.defaultConfig','livewire-tables.multiSelectDropdownFilter.defaultOptions','livewire-tables.multiSelectDropdownFilter.defaultConfig','livewire-tables.events.enableUserForEvent',
...
'session.partitioned','concurrency.default','view.paths','view.compiled','cors.paths',
...
'admix.path','admix.logo.default','admix.logo.negative','admix.icon.default','admix.icon.negative',
'admix.timestamp.format','admix.language.default','admix.language.available.pt_BR.name','admix.language.available.pt_BR.flag','admix.language.available.en_US.name',
'admix.language.available.en_US.flag','admix.language.available.es_ES.name','admix.language.available.es_ES.flag','admix.schedule.minutes','admix.user.name',
'admix.user.icon','admix.user.sort','admix.role.name','admix.role.icon','admix.role.sort',
'admix.audit.name','admix.audit.icon','admix.audit.sort','audit.enabled','audit.implementation',
...
'audit.queue.delay','audit.console','audit-alias.Agenciafmd\\Postal\\Models\\Postal','audit-alias.Agenciafmd\\Leads\\Models\\Lead','audit-alias.Agenciafmd\\Admix\\Models\\User',
'audit-alias.Agenciafmd\\Admix\\Models\\Role','admix-leads.name','admix-leads.icon','admix-leads.sort','admix-leads.sources',
'admix-postal.name','admix-postal.icon','admix-postal.sort','admix-ui.prefix','admix-ui.tabler.path',
'admix-ui.tabler.version','admix-ui.easymde.upload.max_size','admix-ui.easymde.upload.max_width','admix-ui.easymde.upload.max_height','admix-ui.easymde.upload.quality',
...
'admix.easymde.upload','frontend.html',);
