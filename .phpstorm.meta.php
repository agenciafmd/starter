...
'admix::pages.user.form','admix::partials.message','errors.minimal','errors::minimal','frontend::components.icon',
'frontend::components.pdf','frontend::components.picture','frontend::components.single-source','frontend::components.sources','frontend::html.index',
...
'frontend::html.partials.message','frontend::html.partials.picture','frontend::html.tema','frontend::internal','frontend::master',
'frontend::pages.index','frontend::partials.fonts-preload','frontend::partials.footer','frontend::partials.header','frontend::partials.internal-header',
'frontend::partials.message','frontend::partials.pagination','frontend::partials.picture','frontend::partials.pwa','livewire-tables::components.pagination',
'livewire-tables::components.table.td.plain','livewire-tables::components.table.th.plain','livewire-tables::components.table.tr','livewire-tables::components.table.tr.bulk-actions','livewire-tables::components.tools.filter-label',
'livewire-tables::components.tools.filters.text-field','livewire-tables::components.tools.toolbar.items.bulk-actions','livewire-tables::components.tools.toolbar.items.column-select','livewire-tables::components.tools.toolbar.items.filter-button','livewire-tables::components.tools.toolbar.items.filter-popover',
...
'vendor.livewire-tables.components.tools.toolbar.items.column-select','vendor.livewire-tables.components.tools.toolbar.items.filter-button','vendor.livewire-tables.components.tools.toolbar.items.filter-popover','vendor.livewire-tables.components.tools.toolbar.items.search-field','vendor.livewire-tables.includes.custom',
'welcome','horizon::layout','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'admix-postal::fields.0','admix-ui::fields.0','livewire-tables::core.All','livewire-tables::core.All Columns','livewire-tables::core.Applied Filters',
