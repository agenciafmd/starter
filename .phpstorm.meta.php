...
'filesystems.disks.cdn.password','filesystems.disks.cdn.url','filesystems.disks.cdn.ssl','filesystems.links./var/www/html/public/storage','horizon.domain',
...
'audit-alias.Agenciafmd\\Postal\\Models\\Postal','audit-alias.Agenciafmd\\Leads\\Models\\Lead','audit-alias.Agenciafmd\\Admix\\Models\\User','audit-alias.Agenciafmd\\Admix\\Models\\Role','admix-icons.sets.0.name',
...
'livewire.upload-file','livewire.preview-file','frontend.index','admix.auth.login',
...
'admix.postal.trash','admix.postal.create','admix.postal.edit','admix-ui.docs','frontend.html',);
        registerArgumentsSet('views', 
'errors.minimal','errors::minimal','frontend::components.icon','frontend::components.pdf','frontend::components.picture',
'frontend::components.single-source','frontend::components.sources','frontend::html.index','frontend::html.internal','frontend::html.master',
...
'frontend::html.tema','frontend::internal','frontend::master','frontend::pages.index','frontend::partials.fonts-preload',
'frontend::partials.footer','frontend::partials.header','frontend::partials.internal-header','frontend::partials.message','frontend::partials.pagination',
'frontend::partials.picture','frontend::partials.pwa','livewire-tables::components.pagination','livewire-tables::components.table.td.plain','livewire-tables::components.table.th.plain',
'livewire-tables::components.table.tr','livewire-tables::components.table.tr.bulk-actions','livewire-tables::components.tools.filter-label','livewire-tables::components.tools.filters.text-field','livewire-tables::components.tools.toolbar.items.bulk-actions',
'livewire-tables::components.tools.toolbar.items.column-select','livewire-tables::components.tools.toolbar.items.filter-button','livewire-tables::components.tools.toolbar.items.filter-popover','livewire-tables::components.tools.toolbar.items.search-field','livewire-tables::includes.custom',
'vendor.livewire-tables.components.pagination','vendor.livewire-tables.components.table.td.plain','vendor.livewire-tables.components.table.th.plain','vendor.livewire-tables.components.table.tr','vendor.livewire-tables.components.table.tr.bulk-actions',
'vendor.livewire-tables.components.tools.filter-label','vendor.livewire-tables.components.tools.filters.text-field','vendor.livewire-tables.components.tools.toolbar.items.bulk-actions','vendor.livewire-tables.components.tools.toolbar.items.column-select','vendor.livewire-tables.components.tools.toolbar.items.filter-button',
'vendor.livewire-tables.components.tools.toolbar.items.filter-popover','vendor.livewire-tables.components.tools.toolbar.items.search-field','vendor.livewire-tables.includes.custom','welcome','admix-leads::pages.lead.form',
'admix-mail::button','admix-mail::footer','admix-mail::greeting','admix-mail::header','admix-mail::icon',
'admix-mail::layout','admix-mail::markdown.email','admix-mail::markdown.message','admix-mail::subcopy','admix-postal::pages.postal.form',
'admix-ui::docs','admix-ui::livewire-tables.columns.boolean','admix-ui::livewire-tables.columns.delete','admix-ui::livewire-tables.columns.edit','admix-ui::livewire-tables.columns.emit',
'admix-ui::livewire-tables.columns.modal','admix-ui::livewire-tables.columns.restore','admix-ui::livewire-tables.components.table.td','admix-ui::livewire-tables.components.table.td.plain','admix-ui::livewire-tables.components.table.th.plain',
'admix-ui::livewire-tables.components.table.tr','admix-ui::livewire-tables.components.table.tr.bulk-actions','admix-ui::livewire-tables.components.tools.filter-label','admix-ui::livewire-tables.components.tools.filters.text-field','admix-ui::livewire-tables.datatable',
'admix-ui::livewire-tables.includes.custom','admix-ui::livewire-tables.includes.pagination-items','admix-ui::livewire-tables.toolbar.after-toolbar','admix-ui::livewire-tables.toolbar.before-toolbar','admix-ui::livewire-tables.toolbar.bulk-actions',
'admix-ui::livewire-tables.toolbar.column-select','admix-ui::livewire-tables.toolbar.filters','admix-ui::livewire-tables.toolbar.filters-rows','admix-ui::livewire-tables.toolbar.pagination','admix-ui::livewire-tables.toolbar.reorder',
'admix-ui::livewire-tables.toolbar.search','admix-ui::livewire-tables.vendor.components.pagination','admix-ui::livewire-tables.vendor.components.table.td.plain','admix-ui::livewire-tables.vendor.components.table.th.plain','admix-ui::livewire-tables.vendor.components.table.tr',
'admix-ui::livewire-tables.vendor.components.table.tr.bulk-actions','admix-ui::livewire-tables.vendor.components.tools.filter-label','admix-ui::livewire-tables.vendor.components.tools.filters.text-field','admix-ui::livewire-tables.vendor.components.tools.toolbar.items.bulk-actions','admix-ui::livewire-tables.vendor.components.tools.toolbar.items.column-select',
'admix-ui::livewire-tables.vendor.components.tools.toolbar.items.filter-button','admix-ui::livewire-tables.vendor.components.tools.toolbar.items.filter-popover','admix-ui::livewire-tables.vendor.components.tools.toolbar.items.search-field','admix-ui::livewire-tables.vendor.includes.custom','admix::auth.forgot-password',
'admix::auth.login','admix::auth.reset-password','admix::components.aside','admix::components.aside.dropdown','admix::components.aside.item',
'admix::components.header','admix::components.profile','admix::internal','admix::master','admix::pages.dashboard',
'admix::pages.profile.change-password','admix::pages.profile.master','admix::pages.profile.my-account','admix::pages.role.form','admix::pages.user.form',
'admix::partials.message','horizon::layout','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'laravel-exceptions::layout','laravel-exceptions::minimal','livewire-tables::components.includes.actions','livewire-tables::components.includes.loading','livewire-tables::components.pagination',
...
'livewire-tables::components.tools.filter-pills.item','livewire-tables::components.tools.filters.boolean','livewire-tables::components.tools.filters.date','livewire-tables::components.tools.filters.date-range','livewire-tables::components.tools.filters.datetime',
