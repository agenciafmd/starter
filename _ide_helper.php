...
namespace Facades\Agenciafmd\Support {
    ...
    class Helper {
         ...
         * @static
         */
        public static function secretPhone($string, $initialChars = 4, $finalChars = 2)
        {
            return \Agenciafmd\Support\Helper::secretPhone($string, $initialChars, $finalChars);
        }
        ...
        {
            return \Agenciafmd\Support\Helper::onlyNumbers($string);
        }
        ...
        {
            return \Agenciafmd\Support\Helper::onlyAlphanumeric($string);
        }
        ...
        {
            return \Agenciafmd\Support\Helper::mask($string, $mask);
        }
        ...
        {
            return \Agenciafmd\Support\Helper::sanitizePhone($phone);
        }
        ...
        {
            return \Agenciafmd\Support\Helper::sanitizeCpf($cpf);
        }
         ...
         * @static
         */
        public static function sanitizeCnpj($cnpj)
        {
            return \Agenciafmd\Support\Helper::sanitizeCnpj($cnpj);
        }
        ...
        {
            return \Agenciafmd\Support\Helper::sanitizeRg($rg);
        }
        ...
        {
            return \Agenciafmd\Support\Helper::sanitizeEmail($email);
        }
        ...
        {
            return \Agenciafmd\Support\Helper::sanitizeName($name);
        }
        ...
        {
            return \Agenciafmd\Support\Helper::sanitizePostalCode($postalCode);
        }
         ...
         * @static
         */
        public static function sanitizeSchedule($schedule)
        {
            return \Agenciafmd\Support\Helper::sanitizeSchedule($schedule);
        }
         ...
         * @static
         */
        public static function sanitizeYoutube($url)
        {
            return \Agenciafmd\Support\Helper::sanitizeYoutube($url);
        }
        ...
        {
            return \Agenciafmd\Support\Helper::youtubeId($url);
        }
        ...
        {
            return \Agenciafmd\Support\Helper::printable($string);
        }
         ...
         * @static
         */
        public static function success($data, $message = 'Item encontrado', $code = 200)
        {
            return \Agenciafmd\Support\Helper::success($data, $message, $code);
        }
        ...
        {
            return \Agenciafmd\Support\Helper::error($data, $message, $code);
        }
        ...
        {
            return \Agenciafmd\Support\Helper::formatMoney($value, $currency);
        }
         ...
         * @static
         */
        public static function httpStripQueryParam($param, $value = null, $url = null)
        {
            return \Agenciafmd\Support\Helper::httpStripQueryParam($param, $value, $url);
        }
...
namespace Illuminate\Support {
    ...
    class Str {
         ...
         * @static
         */
        public static function localSquish($string)
        {
            return \Illuminate\Support\Str::localSquish($string);
        }
        ...
        public static function printable($string)
        {
            return \Illuminate\Support\Str::printable($string);
        }
         ...
         * @static
         */
        public static function numbersToWords($string, $dictionary = [])
        {
            return \Illuminate\Support\Str::numbersToWords($string, $dictionary);
        }
    ...
    class Stringable {
        /**
         * @see \Agenciafmd\Support\Providers\StrServiceProvider::loadStringableMacros()
         * @param string $delimiter
         * @static
         */
         ...
         * @static
         */
        public static function readDuration()
        {
            return \Illuminate\Support\Stringable::readDuration();
        }
        ...
        {
            return \Illuminate\Support\Stringable::sanitizeName();
        }
         ...
         * @static
         */
        public static function localSquish()
        {
            return \Illuminate\Support\Stringable::localSquish();
        }
        ...
        {
            return \Illuminate\Support\Stringable::printable();
        }
         ...
         * @static
         */
        public static function numbersToWords($dictionary = [])
        {
            return \Illuminate\Support\Stringable::numbersToWords($dictionary);
        }
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {        /**
        ...
        {
            return \Illuminate\Database\Eloquent\Builder::toSelectOptions($label, $value, $disabled);
        }
