...
<main id="banner"
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        <div class="bs-component">
          ...
          <p class="text-muted">Fusce dapibus, tellus ac cursus commodo, tortor
                                mauris nibh.</p>
          <p class="text-primary">Nullam id dolor id nibh ultricies vehicula ut
                                  id elit.</p>
          <p class="text-secondary">Pellentesque ornare sem lacinia quam
          ...
          <div id="myTabContent"
            ...
            <div class="tab-pane fade show active"
              ...
              <p>Raw denim you probably haven't heard of them jean shorts
                 ...
                 banh mi, qui irure terry richardson ex squid. Aliquip placeat
      ...
      <div class="col-lg-4">
        <div class="bs-component">
          <div class="list-group">
            ...
            <a href="#"
               class="list-group-item list-group-item-action disabled">Morbi leo
                                                                       risus
            </a>
          </div>
        </div>
  ...
  <div class="bs-docs-section">
    ...
    <div class="row g-1 mb-2 bg-light">
      <div class="col-auto">
        <div class="bs-component">
          <x-frontend::icon class="ic-lg text-primary"
                            name="fmd-logo" />
        </div>
      </div>
    </div>
  ...
  <h2>Select de cidade e estado</h2>
  <div class="row gy-1 gy-lg-0">
    <div class="col-lg-6">
      <select name=""
              data-selected="São Paulo"
              class="js-state form-select">
        <option value=""></option>
      </select>
    </div>
    <div class="col-lg-6">
      <select name=""
              class="js-city form-select">
        <option value=""></option>
      </select>
    </div>
  </div>
...
<script>
  (function () {
    ...
    if (sourceModalElem) {
      var sourceModal = new bootstrap.Modal(document.getElementById(
          'source-modal'));
    }
