...
<section class="bg-white">
      ...
      <ul class="list-unstyled">
        <li class="my-0h">
          <button class="btn d-inline-flex align-items-center collapsed border-0"
                  ...
                  aria-controls="contents-collapse">Contents
          </button>
          <ul class="list-unstyled ps-1 collapse"
        ...
        <li class="my-0h">
          <button class="btn d-inline-flex align-items-center collapsed border-0"
                  ...
                  aria-controls="forms-collapse">Forms
          </button>
          <ul class="list-unstyled ps-1 collapse"
              id="forms-collapse">
            <li>
            ...
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
                 href="#disabled-forms">Disabled forms
              </a>
            </li>
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
            ...
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
                 href="#input-group">Input group
              </a>
            </li>
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
                 href="#floating-labels">Floating labels
              </a>
            </li>
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
        ...
        <li class="my-0h">
          ...
          <ul class="list-unstyled ps-1 collapse"
            ...
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
                 href="#button-group">Button group
              </a>
            </li>
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
            ...
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
                 href="#dropdowns">Dropdowns
              </a>
            </li>
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
                 href="#list-group">List group
              </a>
            </li>
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
            ...
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
                 href="#pagination">Pagination
              </a>
            </li>
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
                 href="#popovers">Popovers
              </a>
            </li>
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
            ...
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
                 href="#scrollspy">Scrollspy
              </a>
            </li>
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
                 href="#spinners">Spinners
              </a>
            </li>
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
        ...
        <li class="my-0h">
          <button class="btn d-inline-flex align-items-center collapsed border-0"
                  data-bs-toggle="collapse"
                  aria-expanded="false"
                  data-bs-target="#components-project-collapse"
                  aria-controls="components-project-collapse">Componentes do
                                                              Projeto
          </button>
          <ul class="list-unstyled ps-1 collapse"
              id="components-project-collapse">
            <!--Adicione a listagem aqui -->
            <li>
              <a class="d-inline-flex align-items-center rounded text-decoration-none"
                 href="#add">Adicione aqui
              </a>
            </li>
          </ul>
        </li>
  ...
  <div class="bd-cheatsheet container-fluid bg-light">
    <section id="content">
      <h2 class="sticky-md-top fw-bold pt-md-2">Contents</h2>
      ...
      <article class="my-3"
        ...
        <div>
          <div class="bd-example-snippet bd-code-snippet">
            <div class="bd-example m-0 border-0">
              <svg class="bd-placeholder-img bd-placeholder-img-lg"
                   width="100%"
                   height="250"
          ...
          <div class="bd-example-snippet bd-code-snippet">
            <div class="bd-example m-0 border-0">
              <svg class="bd-placeholder-img img-thumbnail"
                   ...
                   preserveAspectRatio="xMidYMid slice"
                   focusable="false"><title>A generic square placeholder image
                                            with a white border around it,
                                            making
                                            it resemble a photograph taken with
                                            an
      ...
      <article class="my-3"
        ...
        <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
          ...
          <a class="d-flex align-items-center"
             target="_blank"
             href="https://getbootstrap.com/docs/5.3/content/tables/">
            Documentation
          </a>
        </div>
      ...
      <article class="my-3"
        ...
        <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
          ...
          <a class="d-flex align-items-center"
             target="_blank"
             href="https://getbootstrap.com/docs/5.3/content/figures/">
            Documentation
          </a>
        </div>
    ...
    <section id="forms">
      <h2 class="sticky-md-top fw-bold pt-md-2">Forms</h2>
                ...
                <fieldset class="mb-3">
                  ...
                  <div class="form-check">
                    <input type="radio"
                           ...
                           id="exampleRadio1">
                    <label class="form-check-label"
                           for="exampleRadio1">Default radio
                    </label>
                  </div>
                  <div class="mb-3 form-check">
                    <input type="radio"
                           ...
                           id="exampleRadio2">
                    <label class="form-check-label"
                           for="exampleRadio2">Another radio
                    </label>
                  </div>
                </fieldset>
                <div class="mb-3">
      ...
      <article class="my-3"
        ...
        <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
          ...
          <a class="d-flex align-items-center"
             target="_blank"
             href="https://getbootstrap.com/docs/5.3/forms/overview/#disabled-forms">
            Documentation
          </a>
        </div>
                ...
                <fieldset disabled
                  ...
                  <div class="mb-3">
                    <label for="disabledTextInput"
                           class="form-label">Disabled input
                    </label>
                    <input type="text"
                  ...
                  <div class="mb-3">
                    <label for="disabledSelect"
                           class="form-label">Disabled select menu
                    </label>
                  ...
                  <fieldset class="mb-3">
                    ...
                    <div class="form-check">
                      <input type="radio"
                             ...
                             disabled>
                      <label class="form-check-label"
                             for="disabledRadio1">Disabled radio
                      </label>
                    </div>
                    <div class="mb-3 form-check">
                      <input type="radio"
                             ...
                             disabled>
                      <label class="form-check-label"
                             for="disabledRadio2">Another radio
                      </label>
                    </div>
                  </fieldset>
                  <div class="mb-3">
                    <label class="form-label"
                           for="disabledCustomFile">Upload
                    </label>
                    <input type="file"
                           class="form-control"
                  ...
                  <div class="mb-3 form-check form-switch">
                    <input class="form-check-input"
                           ...
                           disabled>
                    <label class="form-check-label"
                           for="disabledSwitchCheckChecked">Disabled checked
                                                            switch checkbox
                                                            input
                    </label>
                  </div>
      ...
      <article class="my-3"
        ...
        <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
          ...
          <a class="d-flex align-items-center"
             target="_blank"
             href="https://getbootstrap.com/docs/5.3/forms/form-control/#sizing">
            Documentation
          </a>
        </div>
        ...
        <div>
          <div class="bd-example-snippet bd-code-snippet">
            <div class="bd-example m-0 border-0">
              ...
              <label for="basic-url"
                     class="form-label">Your vanity URL
              </label>
              <div class="input-group mb-3">
                <span class="input-group-text"
    ...
    <section id="components">
      <h2 class="sticky-xl-top fw-bold pt-md-2">Components</h2>
          ...
          <div class="bd-example-snippet bd-code-snippet">
            <div class="bd-example m-0 border-0">
              ...
              <div class="alert alert-primary alert-dismissible fade show"
                ...
                <a href="#"
                   class="alert-link">an example link
                </a>
      ...
      <article class="my-3"
        ...
        <div>
          <div class="bd-example-snippet bd-code-snippet">
            <div class="bd-example m-0 border-0">
              <p class="h1">Example heading
                <span class="badge bg-primary">New</span></p>
              <p class="h2">Example heading
                <span class="badge bg-secondary">New</span></p>
              <p class="h3">Example heading
                <span class="badge bg-success">New</span></p>
              <p class="h4">Example heading
                <span class="badge bg-danger">New</span></p>
              <p class="h5">Example heading <span class="badge text-bg-warning">New</span>
              </p>
              <p class="h6">Example heading
                <span class="badge text-bg-info">New</span></p>
              <p class="h6">Example heading
                <span class="badge text-bg-light">New</span></p>
              <p class="h6">Example heading
          ...
          <div class="bd-example-snippet bd-code-snippet">
            <div class="bd-example m-0 border-0">
              <div class="list-group">
                <a href="#"
                   class="list-group-item list-group-item-action">A simple
                                                                  default
                                                                  list group
                                                                  item
                </a>
      ...
      <article class="my-3"
        ...
        <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
          ...
          <a class="d-flex align-items-center"
             target="_blank"
             href="https://getbootstrap.com/docs/5.3/components/modal/">
            Documentation
          </a>
        </div>
            ...
            <div class="bd-example m-0 border-0">
              ...
              <div class="tab-content"
                ...
                <div class="tab-pane fade show active"
                  ...
                  <p>This is some placeholder content the <strong>Home
                                                                  tab's</strong>
                     associated content. Clicking another tab will toggle the
                     visibility of this one for the next. The tab JavaScript
                     swaps
                     classes to control the content visibility and styling. You
                     can use it with tabs, pills, and any other
                    <code>.nav</code>-powered
                     navigation.</p>
                </div>
                <div class="tab-pane fade"
                  ...
                  <p>This is some placeholder content the <strong>Profile
                                                                  tab's</strong>
                     associated content. Clicking another tab will toggle the
                     visibility of this one for the next. The tab JavaScript
                     swaps
                ...
                <div class="tab-pane fade"
                  ...
                  <p>This is some placeholder content the <strong>Contact
                                                                  tab's</strong>
                     associated content. Clicking another tab will toggle the
                     visibility of this one for the next. The tab JavaScript
                     swaps
              ...
              <nav class="navbar navbar-expand-lg bg-body-tertiary">
                <div class="container-fluid">
                  <a class="navbar-brand"
                     href="#">
                    <img src="/docs/5.3/assets/brand/bootstrap-logo-white.svg"
                         width="38"
                         height="30"
      ...
      <article class="my-3"
        ...
        <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
          ...
          <a class="d-flex align-items-center"
             target="_blank"
             href="https://getbootstrap.com/docs/5.3/components/scrollspy/">
            Documentation
          </a>
        </div>
        ...
        <div>
          <div class="bd-example">
            <nav id="navbar-example2"
                 class="navbar bg-body-tertiary px-3">
              <a class="navbar-brand"
                 href="#">Navbar
              </a>
              <ul class="nav nav-pills">
                <li class="nav-item">
                  <a class="nav-link active"
                     href="#scrollspyHeading1">First
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link"
                     href="#scrollspyHeading2">Second
                  </a>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle"
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a class="dropdown-item"
                         href="#scrollspyHeading3">Third
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item"
                         href="#scrollspyHeading4">Fourth
                      </a>
                    </li>
                    <li>
                      <hr class="dropdown-divider">
            ...
            <div data-bs-spy="scroll"
              ...
              <p>This is some placeholder content for the scrollspy page. Note
                 ...
                 link
                 is highlighted. It's repeated throughout the component example.
      ...
      <article class="my-3"
        ...
        <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
          ...
          <a class="d-flex align-items-center"
             target="_blank"
             href="https://getbootstrap.com/docs/5.3/components/spinners/">
            Documentation
          </a>
        </div>
      ...
      <article class="my-3"
        ...
        <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
          ...
          <a class="d-flex align-items-center"
             target="_blank"
             href="https://getbootstrap.com/docs/5.3/components/toasts/">
            Documentation
          </a>
        </div>
    ...
    <section id="components-project">
      <h2 class="sticky-xl-top fw-bold pt-md-2">Componentes do Projeto</h2>
      ...
      <article class="my-3"
        ...
        <div>
          <div class="bd-example-snippet bd-code-snippet">
            <div class="bd-example m-0 border-0">
              <p>Adicione aqui o conteúdo do componente</p>
            </div>
          </div>
  ...
  <div class="modal fade"
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5"
              id="staticBackdropLiveLabel">Modal title</h1>
          <button type="button"
                  class="btn-close"
                  data-bs-dismiss="modal"
                  aria-label="Close"></button>
  ...
  <div class="modal fade"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5"
              id="exampleModalCenteredScrollableTitle">Modal title</h1>
          <button type="button"
                  class="btn-close"
                  data-bs-dismiss="modal"
                  aria-label="Close"></button>
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-4"
              id="exampleModalFullscreenLabel">Full screen modal</h1>
          <button type="button"
                  class="btn-close"
                  data-bs-dismiss="modal"
                  aria-label="Close"></button>
