                        ...
                        <div wire:key="{{ $tableName }}-columnSelect-selectAll-{{ rand(0,1000) }}">
                            ...
                            >
                                <input
                                    ...
                                    @if($component->getSelectableSelectedColumns()->count() == $component->getSelectableColumns()->count())  wire:click="deselectAllColumns"
                                    @else wire:click="selectAllColumns" @endif
                                >
...
@elseif ($isBootstrap)
    <div
        @class([
            'ms-0 ms-md-2 mb-3 mb-md-0' => !$component->getColumnSelectIsHiddenOnMobile() && !$component->getColumnSelectIsHiddenOnTablet(),
                    ...
                    <div wire:key="{{ $tableName }}-columnSelect-selectAll-{{ rand(0,1000) }}">
                        <label wire:loading.attr="disabled" class="px-2 mb-1">
                            <input
                                wire:loading.attr="disabled"
                                type="checkbox"
                                @if($component->getSelectableSelectedColumns()->count() == $component->getSelectableColumns()->count()) checked
                                wire:click="deselectAllColumns" @else unchecked wire:click="selectAllColumns" @endif
                            />
