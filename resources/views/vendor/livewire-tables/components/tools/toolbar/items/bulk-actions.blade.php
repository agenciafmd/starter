...
>
    ...
    >
        <button
            @class([
                'btn dropdown-toggle d-block d-md-inline' =>  $this->isBootstrap,
        ...
        @else
            <div
                @class([
                    'dropdown-menu dropdown-menu-right w-100' => $this->isBootstrap4,
            ...
            >
                @foreach ($this->getBulkActions() as $action => $title)
                    <a
                        ...
                        wire:key="{{ $tableName }}-bulk-action-{{ $action }}"
                        @class([
                            'dropdown-item' => $this->isBootstrap,
                        ])
                    >
                        {{ $title }}
                    </a>
